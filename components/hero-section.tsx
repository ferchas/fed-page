...
export function HeroSection() {
  ...
  const content = {
    es: {
      title: "Software a medida para impulsar tu PyME",
      subtitle: "En FEDC creamos soluciones digitales que transforman tu negocio.",
    ...
    en: {
      ...
      subtitle: "At FEDC we create digital solutions that transform your business.",
  ...
  return (
    <section id="inicio" className="relative min-h-screen flex items-center bg-gradient-to-br from-background to-muted">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl text-muted-foreground max-w-2xl">{content[language].subtitle}</p>
            </div>
