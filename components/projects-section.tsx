      ...
      projects: [
        {
          ...
          description:
            "Plataforma integral para gestión de ventas, inventario y clientes para un  sector retail.",
        ...
        },
        {
          ...
          description:
            "Aplicación móvil y web para restaurante local con sistema de pedidos en tiempo real.",
        ...
        },
        {
          ...
          description:
            "Sitio web corporativo con sistema de reservas y gestión de clientes para empresa de servicios.",
          result: "Reducción del 50% en tiempo de gestión",
          technologies: ["Next.js", "Supabase", "Tailwind"],
          image: "/images/professional-services-website-booking.png",
        },
      ],
    },
    en: {
      ...
      projects: [
        {
          ...
          description:
            "Comprehensive platform for sales, inventory and customer management for a retail SME.",
        ...
        },
        {
          name: "Delivery App",
          description:
            "Mobile and web application for local restaurant with real-time ordering system.",
        ...
        },
        {
          ...
          description:
            "Corporate website with booking system and customer management for service company.",
